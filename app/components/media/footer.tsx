...
const footerLinks = {
  ...
  etudiant: [
    ...
    { name: "Enseignement supérieur", href: "/etudiant/enseignement-superieur" },
    ...
    <footer className="bg-background text-foreground border-t border-border">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-10">
          <LinkColumn title="Dossiers d'actualité" links={footerLinks.dossiers} />
          <LinkColumn title="Séries" links={footerLinks.series} />
          <LinkColumn title="Sports" links={footerLinks.sports} />
          <LinkColumn title="Politique" links={footerLinks.politique} />
          <LinkColumn title="Étudiant" links={footerLinks.etudiant} />
          <LinkColumn title="Sorties" links={footerLinks.sorties} />
          <LinkColumn title="Vidéos" links={footerLinks.videos} />
